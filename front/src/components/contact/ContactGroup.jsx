...
export default function ContactGroup({
  ...
  function setFocus() {
    return chatType === "groups" && chatId === group.id
      ? "bg-gray-300"
      : "bg-gray-100";
  }
  ...
  return (
    <li
      ...
      className={
        "my-2 rounded-md flex gap-2 items-center justify-start text-xs font-bold shadow-md p-2 bg-gray-100 hover:bg-gray-300 transition-colors cursor-pointer" +
        " " +
        setFocus()
      }
    >
